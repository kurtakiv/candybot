...
This is a sample template for candyquennbakerybot - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name candyquennbakerybot \
...
```bash
sam logs -n HelloWorldFunction --stack-name candyquennbakerybot --tail
```
...
```bash
aws cloudformation delete-stack --stack-name candyquennbakerybot
```
